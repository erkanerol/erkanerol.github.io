...
Not: İşbu yazı Wikipedia kullanılarak yazılmıştır. Arzu edenler [şu](https://en.wikipedia.org/wiki/Hash_function) link üzerinden devam edebilir.
...
<br><br>
Hash fonksiyonları ile ilgili benim anlatacaklarım bu kadar. Metinde bir hata gördüyseniz lütfen aşağıya yorum olarak belirtin. Bir sonraki yazıda ***Public Key Infrastructure (PKI)*** anlatacağım. [Twitter](https://twitter.com/erkan_erol_) üzerinden takipte kalabilirsiniz :)